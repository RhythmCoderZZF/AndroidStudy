package com.example.android_study._view._recyclerview.nest_recycler;
...
import com.example.android_study._view._recyclerview.nest_recycler.adapter.Adapter;
import com.example.android_study._view._recyclerview.nest_recycler.adapter.Datas;
import com.example.android_study._view._recyclerview.nest_recycler.adapter.RvAdapter;
...
public class RecyclerViewActivity extends BaseActivity {
    ...
    protected void initViewAndData(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new Adapter(manager1, R.layout.item_recycler_view, mDatas);
