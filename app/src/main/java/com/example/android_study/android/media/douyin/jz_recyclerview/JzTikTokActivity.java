...
public class JzTikTokActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_j_z_video);
    ...
    private void autoPlayVideo(int postion) {
        ...
        JzvdStdTikTokPlayer player = rvTiktok.getChildAt(0).findViewById(R.id.videoplayer);
        if (player != null) {
