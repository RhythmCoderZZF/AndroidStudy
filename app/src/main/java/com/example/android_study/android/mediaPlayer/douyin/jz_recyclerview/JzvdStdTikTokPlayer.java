...
public class JzvdStdTikTokPlayer extends JzvdStd {
    public JzvdStdTikTokPlayer(Context context) {
        super(context);
    }

    public JzvdStdTikTokPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
