...
import com.example.android_study.samples.photoTag.util.BitmapHelper;
import com.example.android_study.samples.photoTag.util.FileUtil;
...
public class ImageDragRectLayout extends FrameLayout implements View.OnClickListener {
    ...
    void initView(final Context context) {
        ...
        photoView.setOnMatrixChangeListener(rf -> {
            if (imageViewWidth == -1) {
