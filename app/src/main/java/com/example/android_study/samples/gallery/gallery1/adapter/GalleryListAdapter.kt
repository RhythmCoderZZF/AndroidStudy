package com.example.android_study.samples.gallery.gallery1.adapter
...
class GalleryListAdapter : ListAdapter<Hit, GalleryListAdapter.VH>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        holder.itemView.setOnClickListener {
            Bundle().also {
                ...
                it.putParcelable(PHOTO, item)
                holder.itemView.findNavController().navigate(R.id.action_galleryListFragment_to_galleryDetailFragment, it)
            }
        }
        return holder
    }
