package com.example.android_study.event_system.event_util.Scroller.fling_view
...
class ChartView @JvmOverloads constructor(
     ...
     * 柱子路径
     */
    private var mBarPath: Path? = null
    ...
    private fun init(context: Context) {
        isClickable = true
        mDescTextSize = dip2px(context, 12f).toFloat()
        mDotInnerRadius = dip2px(context, 3.5f).toFloat()
        mDotOuterRadius = dip2px(context, 5f).toFloat()
        mBarInterval = dip2px(context, 40f).toFloat()
        mBottomSpacing = dip2px(context, 10f).toFloat()
        mBarTextSpacing = dip2px(context, 12f).toFloat()
        mTopSpacing = dip2px(context, 10f).toFloat()
        mBarWidth = dip2px(context, 1.25f).toFloat()
        mPaint = Paint()
    ...
    private inner class FlingRunnable(context: Context?) :
        Runnable {
        private val mScroller = Scroller(context, null, false)
    ...
    companion object {
         ...
         * 内圆的颜色
         */
        private const val INNER_DOT_COLOR = "#99E35B5B"

        /**
         * 外圆的颜色
         */
        private const val OUTER_DOT_COLOR = "#28E35B5B"

        /**
         * 柱的颜色
         */
        private const val BAR_COLOR = "#bb434343"

        /**
         * 文字颜色
         */
        private const val TEXT_COLOR = "#64C5C5C5"
